...
namespace SportsStore.Domain.Concrete
{
    ...
    {
        public string MailToAddress = "davitazizyan@mail.ru";
        public string MailFromAddress = "davitazizyan@mail.ru";
        public bool UseSsl = true;
        public string Username = "davitazizyan@mail.ru";
        public string Password = "qaz123987";
